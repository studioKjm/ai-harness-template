...
- `methodologies/` — 번들 메서드 플러그인 10종 (ouroboros, living-spec, parallel-change, bmad-lite, exploration, strangler-fig, incident-review, threat-model-lite, observability-first, rfc-driven)
- `feedback/` — 피드백 루프 도구
- `examples/` — 스택별 예시
...
번들 10종:
- 0→1 / 1→N: ouroboros (default) · living-spec · parallel-change · bmad-lite
- 모든 단계: exploration · threat-model-lite · rfc-driven
