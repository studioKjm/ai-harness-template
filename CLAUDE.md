...
- `init.sh` — Lite 설치 스크립트 (Harness + Ouroboros commands/agents)
- `lib/` — 공유 유틸리티 (detect-stack, render-template, colors)
...
- `commands/` — Ouroboros 슬래시 커맨드 (interview, seed, run, evaluate, evolve, unstuck, pm)
- `agents/` — 9개 에이전트 페르소나 정의
